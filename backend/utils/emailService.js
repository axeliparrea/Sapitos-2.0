...
const sendOTPEmail = async (email, otp, name) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || 'Sapitos Security <security@sapitos.com>',
      to: email,
      subject: 'Your Sapitos Verification Code',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="https://your-domain.com/assets/images/logo.png" alt="Sapitos Logo" style="max-width: 150px;">
          </div>
          ...
          <p style="margin-top: 30px; font-size: 12px; color: #999; text-align: center;">
            &copy; ${new Date().getFullYear()} Sapitos. All rights reserved.
          </p>
        </div>
      `
    };
